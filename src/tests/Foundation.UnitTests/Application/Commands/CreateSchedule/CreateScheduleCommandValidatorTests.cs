...
public class CreateScheduleCommandValidatorTests
{
    private readonly CreateScheduleCommandValidator _sut =
        new(NullLogger<CreateScheduleCommandValidator>.Instance);

    private static CreateScheduleCommand Valid(
    ...
    public async Task ValidateAsync_WhenNameEmpty_ReturnsErrorForName()
    {
        ...
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(CreateScheduleCommand.Name));
    }
    ...
    public async Task ValidateAsync_WhenGroupNameEmpty_ReturnsErrorForGroupName()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(CreateScheduleCommand.GroupName));
    }
    ...
    public async Task ValidateAsync_WhenScheduleExpressionEmpty_ReturnsErrorForScheduleExpression()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(CreateScheduleCommand.ScheduleExpression));
    }
    ...
    public async Task ValidateAsync_WhenTargetArnEmpty_ReturnsErrorForTargetArn()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(CreateScheduleCommand.TargetArn));
    }
    ...
    public async Task ValidateAsync_WhenRoleArnEmpty_ReturnsErrorForRoleArn()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(CreateScheduleCommand.RoleArn));
    }
    ...
    public async Task ValidateAsync_WhenModeEmpty_ReturnsErrorForMode()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(CreateScheduleCommand.FlexibleTimeWindowMode));
    }
    ...
    public async Task ValidateAsync_WhenFlexibleWithoutWindow_ReturnsErrorForWindow()
    {
        var result = await _sut.ValidateAsync(
            ...
            TestContext.Current.CancellationToken);
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(CreateScheduleCommand.MaximumWindowInMinutes));
    }

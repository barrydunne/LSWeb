...
/// trigger is defined on the bucket's notification configuration; it surfaces here through the
/// function's resource-based policy, where the S3 service is granted permission to invoke the
/// function for a specific source bucket.
/// </summary>

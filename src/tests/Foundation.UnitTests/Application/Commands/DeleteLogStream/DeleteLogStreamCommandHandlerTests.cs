...
public class DeleteLogStreamCommandHandlerTests
{
    private readonly ICloudWatchLogsClient _client = Substitute.For<ICloudWatchLogsClient>();
    private readonly INotificationPublisher _publisher = Substitute.For<INotificationPublisher>();
    private readonly IActivityLog _activityLog = Substitute.For<IActivityLog>();

    private DeleteLogStreamCommandHandler CreateSut()
        => new(_client, _publisher, _activityLog, NullLogger<DeleteLogStreamCommandHandler>.Instance);
    ...
    public async Task Handle_WhenDeleteSucceeds_PublishesSuccess()
    {
        // Arrange
        _client
            .DeleteLogStreamAsync("/app/orders", "stream-1", Arg.Any<CancellationToken>())
        ...
        await _client.Received(1).DeleteLogStreamAsync("/app/orders", "stream-1", Arg.Any<CancellationToken>());

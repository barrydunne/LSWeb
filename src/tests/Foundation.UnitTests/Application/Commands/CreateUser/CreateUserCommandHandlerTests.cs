...
public class CreateUserCommandHandlerTests
{
    ...
    private CreateUserCommandHandler CreateSut()
        => new(_client, _publisher, _activityLog, _searchRefresh, NullLogger<CreateUserCommandHandler>.Instance);
    ...
    public async Task Handle_WhenCreateSucceeds_PublishesSuccessAndRefreshesSearch()
    {
        // Arrange
        _client
            .CreateUserAsync("alice", "/team/", Arg.Any<CancellationToken>())
        ...
        await _client.Received(1).CreateUserAsync("alice", "/team/", Arg.Any<CancellationToken>());

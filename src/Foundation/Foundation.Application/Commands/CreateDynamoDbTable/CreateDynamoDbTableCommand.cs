...
/// <summary>
/// Create a new DynamoDB table with the supplied key schema and billing configuration.
/// </summary>
...
public record CreateDynamoDbTableCommand(
    string TableName,
    ...
    long? WriteCapacityUnits) : ICommand;

...
public class DetachRolePolicyCommandValidatorTests
{
    private readonly DetachRolePolicyCommandValidator _sut =
        new(NullLogger<DetachRolePolicyCommandValidator>.Instance);

    private static DetachRolePolicyCommand Valid(
    ...
    public async Task ValidateAsync_WhenRoleNameEmpty_ReturnsErrorForRoleName()
    {
        ...
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(DetachRolePolicyCommand.RoleName));
    }
    ...
    public async Task ValidateAsync_WhenPolicyArnEmpty_ReturnsErrorForPolicyArn()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(DetachRolePolicyCommand.PolicyArn));
    }

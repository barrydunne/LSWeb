...
public class AttachUserPolicyCommandValidatorTests
{
    private readonly AttachUserPolicyCommandValidator _sut =
        new(NullLogger<AttachUserPolicyCommandValidator>.Instance);

    private static AttachUserPolicyCommand Valid(
    ...
    public async Task ValidateAsync_WhenUserNameEmpty_ReturnsErrorForUserName()
    {
        ...
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(AttachUserPolicyCommand.UserName));
    }
    ...
    public async Task ValidateAsync_WhenPolicyArnEmpty_ReturnsErrorForPolicyArn()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().Contain(_ => _.PropertyName == nameof(AttachUserPolicyCommand.PolicyArn));
    }

...
public class DeleteS3ObjectCommandHandlerTests
{
    ...
    private DeleteS3ObjectCommandHandler CreateSut()
        => new(_client, _publisher, _activityLog, _searchRefresh, NullLogger<DeleteS3ObjectCommandHandler>.Instance);
    ...
    public async Task Handle_WhenDeleteSucceeds_PublishesSuccessAndRefreshesSearch()
    {
        ...
        var result = await sut.Handle(
            new DeleteS3ObjectCommand("data", "orders/readme.txt"),

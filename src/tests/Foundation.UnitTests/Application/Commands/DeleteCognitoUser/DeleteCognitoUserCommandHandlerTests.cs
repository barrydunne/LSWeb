...
public class DeleteCognitoUserCommandHandlerTests
{
    private readonly ICognitoClient _client = Substitute.For<ICognitoClient>();
    private readonly INotificationPublisher _publisher = Substitute.For<INotificationPublisher>();
    private readonly IActivityLog _activityLog = Substitute.For<IActivityLog>();

    private DeleteCognitoUserCommandHandler CreateSut()
        => new(_client, _publisher, _activityLog, NullLogger<DeleteCognitoUserCommandHandler>.Instance);
    ...
    public async Task Handle_WhenDeleteSucceeds_PublishesSuccess()
    {
        // Arrange
        _client
            .DeleteUserAsync("eu-west-1_abc123", "alice", Arg.Any<CancellationToken>())
    ...
    public async Task Handle_WhenDeleteFails_PublishesFailureAndReturnsError()
    {
        // Arrange
        _client
            .DeleteUserAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<CancellationToken>())

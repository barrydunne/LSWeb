...
/// <summary>
/// An SNS topic that publishes to a queue, detected from the queue's access policy. Lets the UI
/// show the relationship as a cross-resource link to the owning topic.
/// </summary>

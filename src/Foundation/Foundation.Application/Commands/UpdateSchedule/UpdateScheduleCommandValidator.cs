...
internal sealed partial class UpdateScheduleCommandValidator : AbstractValidator<UpdateScheduleCommand>
{
    ...
    public UpdateScheduleCommandValidator(ILogger<UpdateScheduleCommandValidator> logger)
    {
        _logger = logger;
    ...
    public override async Task<ValidationResult> ValidateAsync(
        ValidationContext<UpdateScheduleCommand> context, CancellationToken cancellation = default)
    {
    ...
    [LoggerMessage(LogLevel.Warning, "UpdateScheduleCommand validation failure: {Error}")]

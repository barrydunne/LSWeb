...
/// <summary>
/// Update an existing Amazon API Gateway v2 stage with the supplied configuration.
/// </summary>
...
public record UpdateHttpStageCommand(
    string ApiId,
    string StageName,
    bool AutoDeploy,
    string? Description,
    ...
    IReadOnlyDictionary<string, string> StageVariables) : ICommand;

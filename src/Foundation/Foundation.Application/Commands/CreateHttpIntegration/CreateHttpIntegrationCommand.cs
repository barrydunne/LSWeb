...
/// <summary>
/// Create an Amazon API Gateway v2 integration from the supplied configuration. An integration is
/// the backend target a route forwards requests to.
/// </summary>
...
public record CreateHttpIntegrationCommand(
    string ApiId,

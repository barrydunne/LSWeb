...
/// <summary>
/// The desired configuration of an Amazon API Gateway v2 authorizer when creating or updating one.
/// </summary>
/// <param name="ApiId">The identifier of the API the authorizer belongs to.</param>
/// <param name="AuthorizerId">The identifier of the authorizer to update, or <see langword="null"/> when creating a new authorizer.</param>
...
public sealed record HttpAuthorizerSpecification(
    string ApiId,
    string? AuthorizerId,
    string Name,
